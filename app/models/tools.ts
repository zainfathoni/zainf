...
export const aiSubscriptions: Tool[] = [
  {
    slug: "chatgpt-pro",
    title: "ChatGPT Pro (20x) — $200/month",
    href: "https://chatgpt.com/pricing/",
    description:
      "After using Claude Max from January through March 2026, when Anthropic stopped allowing Claude subscription usage in third-party harnesses such as OpenClaw, I initially subscribed to ChatGPT Pro at $100/month (5x). In September 2026, I upgraded to the $200/month (20x) plan to get the model usage I need for my AI workflows.",
  },
  {
    slug: "amp-megawatt",
    ...
    description:
      "I pair Amp Megawatt with ChatGPT Pro, for a total of $220/month. With the subscription, GPT-5.6 Sol calls cost $0 in Amp instead of consuming my credits, so I can make full use of my ChatGPT allocation through the best agent harness I have found.",
  },
];
