...
import * as aiToolsSwegrowthSummaryFeb15Feb22 from "../routes/blog.ai-tools-swe-growth-summary-feb-15-feb-22-2026.mdx";
...
export const getAllPosts = (limit?: number) => {
  const allPosts = [
    getPostFromMdxModule(aiToolsSwegrowthSummaryFeb15Feb22),
