...
import * as postAiToolsSweGrowthApr12Apr192026 from "../routes/blog.ai-tools-swe-growth-apr-12-apr-19-2026.mdx";
...
export const getAllPosts = (limit?: number) => {
  const allPosts = [
    getPostFromMdxModule(postAiToolsSweGrowthApr12Apr192026),
