...
meta:
  ...
  - name: description
    content: "How I built a team of specialized AI agents that manage my code, finances, family logistics, and career — and what I learned burning $1,078/week before getting it under control."
  - author: Zain Fathoni
  - date: 2026-02-21
  - name: keywords
...
Six months ago, I asked a Claude instance to help me plan my week. It did fine — decent schedule, reminded me about deadlines, drafted an email. Solid.
...
3. **Model choice becomes a lever.** Not every task needs the best (most expensive) model. More on this — it saved me ~$900/week.
...
Wheeljack primarily runs on Codex (Anthropic's coding agent, generous free tier) with a premium fallback for complex architectural decisions. This alone saves hundreds of dollars per week.
...
For a personal project. From my own pocket. My wife didn't ask questions, but she gave me a look. You know the look.

Here's how we got it down to ~$146/week — an 86% reduction.
...
| Wheeljack | Codex (free) | Coding agent with generous free tier |
| Ratchet/Arcee | Opus | Therapy needs nuance — don't cheap out |
| Everyone else | Sonnet | Good enough for structured tasks |
| Heartbeats | Haiku | Routine checks don't need heavy intelligence |

Wheeljack on Codex was the single biggest win. Coding tasks are high-volume, and the free tier handles most of them. The premium model falls back only for genuinely complex architectural decisions.

### Strategy 2: Free Model Fallbacks

Tools like [OpenCode](https://opencode.ai) give access to free models — MiniMax M2.5, Kimi K2.5, GLM-5. These aren't as capable as Anthropic's models, but for boilerplate generation, simple refactors, and test writing? They're fine. We use them as Wheeljack's secondary fallback.
...
3. **Watch your costs from day one.** It's easy to burn through hundreds of dollars before you realize Haiku could handle 80% of your workload.
