---
meta:
  - title: "Claude Makin Pelit, Mocin Makin Garang, dan Kita Semua Butuh Istirahat — AI Tools Digest #7"
  - name: description
    content: "Minggu ini Claude Max $200 terasa makin kikir, GPT 5.4 dan model China mulai mengancam tahta Anthropic, dan kita semua sadar: AI bikin produktif tapi juga bikin capek. Rangkuman dari grup AI Tools SWE GROWTH, 9-16 Mar 2026."
  - author: Zain Fathoni
  - date: "2026-03-16"
  - property: og:title
    content: "Claude Makin Pelit, Mocin Makin Garang, dan Kita Semua Butuh Istirahat — AI Tools Digest #7"
...
# Claude Makin Pelit, Mocin Makin Garang, dan Kita Semua Butuh Istirahat

558 pesan dari ~30 kontributor aktif minggu ini. Dan kalau harus merangkum dalam satu kalimat: **semua orang sedang mencari cara supaya tetap produktif tanpa bangkrut — atau burnout.** Claude makin ketat, model China makin menggoda, dan di balik semua optimisasi token itu, ada manusia yang capek. 😮‍💨

---

## 💸 Claude Makin Kikir — $200 Aja Gak Cukup?

Topik paling panas minggu ini. Mas Agung membuka diskusi dengan keluhan yang langsung bikin banyak orang relate: *"claude makin kikir :( biasanya seminggu full trotel cuma kepake 40% sekarang 87%"*. Dan ini di plan Max $200 lho — bukan yang murah.

Diskusi langsung meledak. Beberapa member sudah mulai ambil keputusan drastis. Mas Ivan bahkan mengumumkan: *"saya resmi cancel claude code. Tetap di codex dan kembali..."* — sebuah keputusan yang bukan cuma soal uang, tapi juga soal mental health (lebih lanjut di bagian burnout).

Realitanya memang pahit: *"$200 gak mungkin dikasih los-losan."* Batas kere hore yang di digest sebelumnya sudah naik ke $40, sekarang bahkan $200 pun terasa mencekik kalau pemakaiannya intensif. Ini bukan lagi soal hemat atau boros — ini soal model bisnis subscription yang memang tidak dirancang untuk heavy users.

Tapi ada kabar baik juga. Anthropic memberikan semacam THR Ramadhan — double usage di luar peak hours dan selama weekend. Saya share info ini di grup: *"Ada THR berupa double-usage di luar peak hours & selama weekend."* Lumayan lah buat yang bisa atur jadwal coding-nya di malam hari.
...
Pertanyaan besarnya: apakah ini awal dari exodus massal meninggalkan Anthropic? Atau justru Anthropic akan merespons dengan pricing yang lebih kompetitif? Kita lihat.
