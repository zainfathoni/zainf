...
There's a reason my instinct was "fix the process" rather than "fix the bot." I've [been a manager twice](https://zainf.dev/karir-it) — once leading around 70 people at a Singapore-based company, and later a team of 20+ on the largest project at the company. Both roles taught me the same lesson: when something goes wrong repeatedly, the individual isn't the problem. The process is.
