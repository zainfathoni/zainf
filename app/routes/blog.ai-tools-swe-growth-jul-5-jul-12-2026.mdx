...
meta:
  ...
  - name: description
    content: "Grok 4.5, Cursor, Codex Sol/Terra/Luna, Koma, Amp, opencode, dan Firecrawl. Rangkuman dari grup AI Tools SWE GROWTH, 5-12 Jul 2026."
  - author: Zain Fathoni
  - date: "2026-07-12"
  - lang: id
  - property: og:title
...
3. Pantau [Koma](https://koma.run) kalau kamu tertarik dengan local harness, self-QA, dan workflow agent yang bisa dirakit sesuai budget.

4. Simpan [AI Engineering from Scratch](https://aiengineeringfromscratch.com/index.html) untuk bacaan weekend. Kalau wrapper makin banyak, memahami lapisan bawahnya justru makin bernilai.

5. Pakai credits [Firecrawl](https://www.firecrawl.dev/) untuk proof-of-concept crawler atau data enrichment kecil, lalu tetap hitung harga normalnya.
...
- Zain: membawa konteks Amp/Amux dan ikut melihat arah agents anywhere.
