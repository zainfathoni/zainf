...
meta:
  ...
  - lang: id
  - property: og:title
    content: "Mengenal React, React DOM, dan JSX"
  - property: og:description
    content: "Pengantar awal library React, React DOM, dan syntax JSX beserta latar"
  - property: og:url
    content: "https://www.zainfathoni.com/blog/react-dom-jsx"
  - property: og:image
    content: "https://www.zainfathoni.com/assets/blog-og-react-dom-jsx.png"
