...
function ModeToggle() {
  ...
  function toggleMode() {
    ...
    if (isDarkMode === isSystemDarkMode) {
      delete self.localStorage.isDarkMode;
    } else {
      self.localStorage.isDarkMode = isDarkMode;
    }
  }
...
function AvatarContainer({ className, ...props }: ContainerProps) {
  return (
    <div
      className={clsx(
        className,
...
export function Header() {
  ...
  useEffect(() => {
    ...
    function updateAvatarStyles() {
      ...
      const scrollY = downDelay - self.scrollY;
